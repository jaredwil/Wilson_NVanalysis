function feat = calcFeature_ii(datasets,channels,feature,winLen,outlabel,blockLenSec,parFlag,varargin)
% NOTE: This function is a derivative of calcFeature function developed by
% Hoameng Ung
%Usage: calcFeature_ii(datasets,channels,feature,winLen,blockLenSec,parFlag,varargin)
...
% This function is specific to extract features from Inter Ictal Data

% Parallel Processing Usage: if 
...
%   can be set to improve efficieny. 
%   'parFlag'       :   [0/1] 1: parallel processing (parfor) will be used
%   to increase speed
% %%%%%%%%%%%%%%%%  REMOVED additional function for this%%%%%%%%%%%%%%%%%%%
