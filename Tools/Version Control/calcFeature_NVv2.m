function [feat, numNan] = calcFeature_NVv2(datasets,channels,feature,winLen,dispPercent,outLabel,runIndex,blockLenSecs,parFlag,varargin)
                        ...
                        %componsate for Nans
                            switch feature
                                ...
                                case 'dcn'
                                    ...
                                    y(idxN,:) = [];  %remove indices that are 0;
