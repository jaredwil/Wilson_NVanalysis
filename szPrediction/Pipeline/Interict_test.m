function [ interFeats ] = Interict_test( ptSession, szpredIdx, winLen, winDisp )
...
randBlocks = [randBlocks numBlocks+1];
...
%             j = j + 24; %skip ahead 24 hours
    ...
    if(N > 1500 || (startBlockPt > endSearch) || (endBlockPt > endSearch) )
        break;
    end
